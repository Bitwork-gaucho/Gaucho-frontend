export const Icons = {
  ...
  Truck: () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <rect x="1" y="6" width="4" height="10"></rect>
      <path d="M5 16h15v-5a4 4 0 0 0-4-4H9M6 20h.01M18 20h.01"></path>
    </svg>
  ),
...
export const SmartphoneIcon = ({ size = 20, className = '' }: IconProps) => (
  <span style={{ width: size, height: size, display: 'inline-flex', alignItems: 'center' }} className={className}>
    <Icons.Smartphone />
  </span>
)
...
export const Share2Icon = ({ size = 20, className = '' }: IconProps) => (
  <span style={{ width: size, height: size, display: 'inline-flex', alignItems: 'center' }} className={className}>
    <Icons.Share2 />
  </span>
)
...
export const DollarSignIcon = ({ size = 20, className = '' }: IconProps) => (
  <span style={{ width: size, height: size, display: 'inline-flex', alignItems: 'center' }} className={className}>
    <Icons.DollarSign />
  </span>
)

export const BarChart3Icon = ({ size = 20, className = '' }: IconProps) => (
  <span style={{ width: size, height: size, display: 'inline-flex', alignItems: 'center' }} className={className}>
    <Icons.BarChart3 />
  </span>
)
